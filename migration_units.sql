                ...
                <div className="pay-panel">
                  {isUnitItem(selected) && (
                    <div className="qty-picker">
                      <span className="qty-picker-label">How many packs?</span>
                      <div className="qty-stepper">
                        ...
                        <input
                          ...
                          min="1"
                          value={packs}
                          onChange={(e) => setPacks(Math.max(1, Math.floor(Number(e.target.value) || 1)))}
                        />
                        <button type="button" onClick={() => setPacks((p) => p + 1)}>+</button>
                      </div>
                  ...
                  <div className="pay-hint">
                    ...
                    {isUnitItem(selected) ? formatPrice(packs * selected.price, selected.currency) : formatPrice(selected.price, selected.currency)}.
